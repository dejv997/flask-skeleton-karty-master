...
def upgrade():
    ...
    sa.Column('Skrobanek', sa.String(), nullable=False),
    ...
    op.create_index('ix_loguser_Skrobanek', 'loguser', ['Skrobanek'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('karty')
    op.drop_index('ix_loguser_Skrobanek', table_name='loguser')
